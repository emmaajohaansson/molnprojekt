...
class GamesController extends BaseController
{
  use AuthorizesRequests, DispatchesJobs, ValidatesRequests;
    ...
    public function get($id) {
      ...
      $reviews = app('db')->select("SELECT reviews.reviewId, reviews.rating, reviews.review, reviews.createdAt, users.username FROM reviews INNER JOIN users ON reviews.userId = users.id WHERE reviews.gameId = $id ");
